...
### 문제배경: 대화 속 사실 검증은 왜 어려울까?

(
뉴스 기사나 위키 문서에서 주장검증하는 시도(Fever, Liar, etc.)는 이미 많이 연구되었다. 그런데 대화 속 claim verification은 훨씬 더 까다롭다.
왜냐하면 대화는:
- 길고 산만하다.
- 주장이 얽히고 설켜 있다.
- 증거가 여러 hop에 흩어져 있다.

결국 모델이 해야할 일은 단순히 {문맥 혹은 증거와 주장}으로 구성된 입력 문장을 읽고 Supported/Refuted/NEI 를 분류해내는 게 아니라,
긴 대화 속에서 불필요한 잡음을 걷어내고 핵심 증거를 잘 찾아서 claim과 연결해야한다.

### 법률 도메인을 Testbed로 선택한 이유: 왜 법률이냐?

법률 판결을 떠올려보면, 수십 페이지에 달하는 사실 관계 묘사, 신청인의 가족사나 사회적 배경,, 등 다양한 사실진술로 구성된다.
하지만 판사가 최종 결론을 내릴 때는 
